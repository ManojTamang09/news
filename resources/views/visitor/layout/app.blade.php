        ...
        <div class="sidebar-widget widget_categories mb-50 mt-30">
            ...
            <div class="widget_nav_menu">
                <ul>
                    ...
                    <li class="cat-item cat-item-3"><a href="{{route('postdetails')}}">Book review</a> <span class="post-count">25</span></li>
...
<header class="main-header header-style-1 font-heading">
                            ...
                            <ul class="sub-menu font-small">
                                ...
                                <li class="menu-item-has-children"><a href="#">Category</a>
                                    <ul class="sub-menu font-small">
                                        ...
                                        <li><a href="{{route('postdetails')}}">Grid layout</a></li>
    ...
    <div class="header-sticky">
        <div class="container align-self-center position-relative">
            ...
            <div class="float-right header-tools text-muted font-small .d-none .d-sm-block">
