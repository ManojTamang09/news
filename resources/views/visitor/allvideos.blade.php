...
@section('content')
  ...
  <main>
    ...
    <div class="archive-header pt-50">
        <div class="container">
            <h2 class="font-weight-900">All Videos</h2>
                                ...
                                <div class="row mb-40 list-style-2">
                                    <div class="col-md-4">
                                        <div class="post-thumb position-relative border-radius-5">
                                            ...
                                            <div class="img-hover-slide border-radius-5 position-relative" style="background-image: url('{{asset('titlephoto')}}/{{$vid->title_photo}}')">
                                                <a class="img-link" href="{{route('visitor.detailsvideos',[$vid->id])}}"></a>
                                            </div>
                                    ...
                                    <div class="col-md-8 align-self-center">
                                        <div class="post-content">
                                            <div class="entry-meta meta-0 font-small mb-10">
                                                <a href="{{route('visitor.detailsvideos',[$vid->id])}}"><span class="post-cat text-primary">Food</span></a>
                                            </div>
                                            <h5 class="post-title font-weight-900 mb-20">
                                                <a href="{{route('visitor.details',[$vid->id])}}">{{$vid->heading}}</a>
