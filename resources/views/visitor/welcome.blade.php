                            ...
                            <div class="post-content-overlay">
                                <div class="container">
                                    ...
                                    <h1 class="post-title mb-20 font-weight-900 text-white">
                                        <a class="text-white" href="#" tabindex="0">How to Visit Bali's Monkey Forest</a>
                                    </h1>
                        ...
                        <div class="thumb-overlay position-relative" style="background-image: url(assets/imgs/news/news-17.jpg)">
                            <div class="post-content-overlay">
                                <div class="container">
                                    ...
                                    <h1 class="post-title mb-20 font-weight-900 text-white">
                                        <a class="text-white" href="#" tabindex="0">Abstract Australia from Above</a>
                                    </h1>
                                    <div class="entry-meta meta-1 font-small text-white mt-10 pr-5 pl-5">
                        ...
                        <div class="thumb-overlay position-relative" style="background-image: url(assets/imgs/news/news-18.jpg)">
                            <div class="post-content-overlay">
                                <div class="container">
                                    ...
                                    <h1 class="post-title mb-20 font-weight-900 text-white">
                                        <a class="text-white" href="#" tabindex="0">Tips for Scuba Diving the Great Barrier Reef</a>
                                    </h1>
                                    <div class="entry-meta meta-1 font-small text-white mt-10 pr-5 pl-5">
                                        <span class="post-on">15 September 2020</span>
                        ...
                        <div class="thumb-overlay position-relative" style="background-image: url(assets/imgs/news/news-19.jpg)">
                            <div class="post-content-overlay">
                                <div class="container">
                                    ...
                                    <h1 class="post-title mb-20 font-weight-900 text-white">
                                        <a class="text-white" href="#" tabindex="0">Staying at the Hilton Seychelles Northolme Resort & Spa</a>
                                    </h1>
                                    <div class="entry-meta meta-1 font-small text-white mt-10 pr-5 pl-5">
